...
function ViewCart() {
    return (
        <div>
            <Header />
            {/* link home page */}
            <div className="w-full flex p-10 justify-between" style={{ height: '100px', backgroundColor: '#F2F2F2' }}>
            ...
            <div className="w-full px-20 text-right mb-32">
                ...
                <div className="w-7/12 ml-auto mr-0 mt-10 flex" style={{ border: '1px solid #e5e5e5' }}>
                    <div className="w-5/12" style={{ backgroundColor: '#F5F5F5' }}>
                        <div className="w-full flex items-center text-left font-semibold pl-4 text-sm py-3" style={{ borderBottom: '1px solid #e5e5e5' }}>
                            <span>Tạm tính</span>
                        </div>
                        <div className="w-full flex items-center text-left font-semibold pl-4 text-sm py-3" style={{ height: '100px', borderBottom: '1px solid #e5e5e5' }}>
                            <span>Giao hàng</span></div>
                    ...
                    <div className="w-7/12" style={{ backgroundColor: '#fff' }}>
                        <div className="w-full flex items-center pl-4 font-semibold text-sm py-3" style={{ borderBottom: '1px solid #e5e5e5', color: ' #AF052D' }}>
                            <span>1000.000</span> <span className="underline ml-2"> đ</span>
                        </div>
                        <div className="w-full flex flex-col text-left justify-center font-semibold pl-4 text-sm py-3" style={{ height: '100px', borderBottom: '1px solid #e5e5e5' }}>
                            <div className="w-full flex text-xs">
                                <span className="text-red-500 mr-2">*</span><p>Chỉ giao hàng ở thành phố Hồ Chí Minh</p> <span className="text-gray-400 ml-1">(Miễn phí ship)</span>
                            </div>
                            <input className="border border-gray-300 mr-3 mt-2 p-2" placeholder="Địa chỉ giao hàng" />
                        </div>
                        <div className="w-full flex items-center text-left font-semibold pl-4 text-sm py-3" style={{ color: ' #AF052D' }}>
                            <span>1000.000</span> <span className="underline ml-2"> đ</span>
                        </div>
                    </div>
                </div>
